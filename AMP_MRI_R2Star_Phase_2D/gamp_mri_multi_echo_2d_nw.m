function [res, input_par, output_par] = gamp_mri_multi_echo_2d_nw(A_2_echo, y, gamp_par, input_par, output_par)
    ...
    for (ite_pe = 1:max_pe_spar_ite)
            ...
            tau_p_meas_1 = A_2_echo.multSq(tau_x_meas_psi);
            p_hat_meas_1 = A_2_echo.mult(x_hat_meas_psi) - tau_p_meas_1 * s_hat_meas_1;
            ...
            tau_r_meas_1 = 1 / A_2_echo.multSqTr(tau_s_meas_1);
