classdef A_2_echo_3d_cylinder_LinTrans < LinTrans
	...
	methods
		...
		% Constructor
		function obj = A_2_echo_3d_cylinder_LinTrans(M,N,maps,mat_sz,sm_num,echo_num,coil_num,wav_coef_len,s_vect,Psit,Psi,E,Et,A,Ah,S,St)
			obj = obj@LinTrans;
			...
			if nargin > 15
				if isa(S,'double')&&(S>0)
					...
					obj.FrobNorm = S;
				elseif (nargin > 15)&&(isa(S,'function_handle')&isa(St,'function_handle'))
