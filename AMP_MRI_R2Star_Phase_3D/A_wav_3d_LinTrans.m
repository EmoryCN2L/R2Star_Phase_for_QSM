classdef A_wav_3d_LinTrans < LinTrans
	% A_wav_3d_LinTrans:  Linear transform class for function handles. 
	...
	methods
		...
		% Constructor
		function obj = A_wav_3d_LinTrans(M,N,mat_sz,wav_coef_len,echo_num,A,Ah,E,Et,S,St)
			obj = obj@LinTrans;
			...
			if nargin > 9
				if isa(S,'double')&&(S>0)
					...
					obj.FrobNorm = S;
				elseif (nargin > 9)&&(isa(S,'function_handle')&isa(St,'function_handle'))
