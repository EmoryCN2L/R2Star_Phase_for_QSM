classdef A_x0_r2star_3d_LinTrans < LinTrans
	% A_x0_r2star_3d_LinTrans:  Linear transform class for function handles combining step 3 and 4 
	...
	methods
		...
		% Constructor
		function obj = A_x0_r2star_3d_LinTrans(M,N,mat_sz,wav_coef_len,echo_num,echo_time,A,Ah,E,Et,S,St)
			obj = obj@LinTrans;
			...
			if (M~=mat_sz(1)*mat_sz(2)*mat_sz(3)*echo_num)
		...
		function obj = set.R2star(obj, R2star)
			obj.R2star = R2star;
            E_R2star = zeros([size(R2star,1) size(R2star,2) size(R2star,3) obj.echo_num]);
