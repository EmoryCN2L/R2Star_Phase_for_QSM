function [res, input_par, output_par] = gamp_mri_multi_echo_3d_nw(A_2_echo_3d, y, gamp_par, input_par, output_par)
    ...
    for (ite_pe = 1:max_pe_spar_ite)
            ...
            tau_p_meas_1 = A_2_echo_3d.multSq(tau_x_meas_psi);
            p_hat_meas_1 = A_2_echo_3d.mult(x_hat_meas_psi) - tau_p_meas_1 * s_hat_meas_1;
            ...
            tau_r_meas_1 = 1 / A_2_echo_3d.multSqTr(tau_s_meas_1);
            r_hat_meas_1 = x_hat_meas_psi + tau_r_meas_1 * A_2_echo_3d.multTr(s_hat_meas_1);
            ...
            cvg_gamp = max([ cvg_gamp_x_hat_meas_psi]);
            if (cvg_gamp<cvg_thd) 
                break;
            end
