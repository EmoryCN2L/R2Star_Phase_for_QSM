function [H_exp, V, fun_val_block_1_cur_0, fun_val_block_1_cur_1]=exponential_fit_2d_x0_inner_r2_l1_reg_dict(Et, lambda_2, Psi, Psit, par)
    ...
    for (ii=1:maxiter)
        ...
        fun_val_block_1_cur_1 = sum(abs(Psi(H_exp)));
        ...
        V = exp_lsq_fit_2d_r2_componentwise_dict(Et, H_exp, exp_dict, exp_dict_sq_norm, r2_dict_val);
        V = min(V, V_max);
        V = max(V, V_min);
